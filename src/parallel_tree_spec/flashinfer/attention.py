"""
FlashInfer-backed attention layer for Llama models.

Replaces HuggingFace's LlamaAttention with one that routes through
BeFlashinferWrapper for paged KV cache attention.

Adapted from subspec_v2/specdecodes/models/utils/flashinfer/attention.py
"""
...
from .attention_wrapper import AttentionRotaryParams, POS_ENCODING_MODE
...
class FiLlamaAttention(nn.Module):
    """Llama attention layer using FlashInfer paged attention."""
    ...
    def forward(
        ...
        **kwargs,
        ...
        q, k, v = flashinferWrapper.reshape_qkv_for_attention(query, key, value, batch_position)
